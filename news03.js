...
async function getdata() {
  const res = await fetch("https://newsapi.org/v2/everything?q=sports&apiKey=4a175007142a447783c139567cd092b9");
...
async function getdata2() {
  const res2 = await fetch("https://newsapi.org/v2/everything?q=sports&apiKey=4a175007142a447783c139567cd092b9");
