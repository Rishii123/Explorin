...
async function getdata() {
  const res = await fetch("https://newsapi.org/v2/top-headlines?country=in&apiKey=4a175007142a447783c139567cd092b9");
...
function renderUI() {
  ...
  for (let i = 8; i < 19; i++) {
    ...
    article.innerHTML = `
                        <img src=${data[i].urlToImage} alt=" " class="artical-img">
...
async function getdata2() {
  const res2 = await fetch("https://newsapi.org/v2/top-headlines?country=in&apiKey=4a175007142a447783c139567cd092b9");
